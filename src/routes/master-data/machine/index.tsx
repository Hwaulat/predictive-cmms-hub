    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">List of machines and equipment registered in the system.</p>
        </div>
      ...
      <div className="bg-white rounded-xl border shadow-sm flex flex-col overflow-hidden">
        ...
        <div className="p-4 border-b flex flex-col sm:flex-row gap-4 bg-slate-50 justify-between">
          ...
          <Link to="/master-data/machine/new" className="shrink-0">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-slate-100/50 text-slate-500 uppercase text-xs font-bold tracking-wider border-b">
                ...
                <th className="py-4 px-4 text-left whitespace-nowrap">Line</th>
              </tr>
            </thead>
                ...
                <tr key={i} className="hover:bg-slate-50/50">
                  <td className="py-3 px-4">
                    <div className="flex items-center gap-1">
                      <Link to={`/master-data/machine/${m.code}`}>
                        <Button
                          variant="outline"
                          size="icon"
