        ...
        <div className="space-y-4">
          ...
          <div className="border rounded-lg overflow-x-auto w-full bg-white">
            <div className="min-w-max">
              <div className="bg-slate-100 border-b flex items-center px-4 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider whitespace-nowrap">
            ...
            <div className="w-40 shrink-0">Maker <span className="text-destructive">*</span></div>
              ...
              <div className="flex items-center px-4 py-4 gap-4 whitespace-nowrap">
